	...
	<div class="bg-white mb-16">
	 ...
	 <div class="container">
		...
		<div class="w-full lg:w-8/12 lg:mr-16 flex flex-wrap lg:flex-no-wrap justify-between items start mb-8">
	 		<div class="ordrer-first mr-2">
              <StepNavigationButton

              :step="previousStep"
              >
              		   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current text-white h-6 w-6" width="24" height="24"><path d="M5.41 11H21a1 1 0 0 1 0 2H5.41l5.3 5.3a1 1 0 0 1-1.42 1.4l-7-7a1 1 0 0 1 0-1.4l7-7a1 1 0 0 1 1.42 1.4L5.4 11z"/></svg>
              </StepNavigationButton>
	 		</div>
		 		...
		 		<div class="flex flex-row lg:flex-col ordrer-first lg:ordrer-last">
		 			 <StepNavigationButton
...
import browseSnippet from '@/mixins/snippets/browserSnippet'
